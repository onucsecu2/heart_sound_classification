...
bankdata = pd.read_csv("/home/onu/PycharmProjects/Heart/train/train_2.csv")
X_train = bankdata.drop('class', axis=1)
y_train = bankdata['class']

bankdata = pd.read_csv("/home/onu/PycharmProjects/Heart/test/test_2.csv")
X_test = bankdata.drop('class', axis=1)
y_test = bankdata['class']
...
#
# model = Sequential()
# model.add(Dense(532,input_dim=532,activation='relu'))
...
# model.fit(X_train, y_train, epochs=50,batch_size=50,callbacks=[es],verbose=2)
...
print("my info :")
bankdata = pd.read_csv("/home/onu/PycharmProjects/Heart/test/test.csv")
x_test = bankdata.drop('class', axis=1)

x_test=x_test.iloc[pos,:]
print(x_test.shape)
bankdata = pd.read_csv("/home/onu/PycharmProjects/Heart/train/train_ME_1.csv")
...
# model = Sequential()
# model.add(Dense(20+128,input_dim=20+128,activation='sigmoid'))
# model.add(Dropout(0.1))
...
print(confusion_matrix(y_test,actual_predict))
